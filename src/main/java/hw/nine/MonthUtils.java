...
public final class MonthUtils {
	...
	static final String[] monthArr = { "January", "February", "March", "April", "May", "June", "July", "August",
	...
	public static String getMonth(String abbreviate) {
		if (abbreviate.length() <= 3 && abbreviate.charAt(0) > 96) {
			String[] abb = { "jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec" };
	...
	public static Month[] halfYearArr() {
		return new Month[] { new Month(1), new Month(2), new Month(3), new Month(4), new Month(5), new Month(6) };
	}
